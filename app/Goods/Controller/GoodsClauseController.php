...
/**
 * 服务模板控制器
 * Class GoodsClauseController
 */
#[Controller(prefix: "goods/clause"), Auth]
class GoodsClauseController extends MineController
{
    /**
     * 业务处理服务
     * GoodsClauseService
    ...
    /**
     * 新增
     * @param GoodsClauseRequest $request
     * @return ResponseInterface
     * @throws \Psr\Container\ContainerExceptionInterface
     * @throws \Psr\Container\NotFoundExceptionInterface
     */
    #[PostMapping("save"), Permission("goods:clause:save"), OperationLog]
     ...
     * @throws \Psr\Container\NotFoundExceptionInterface
     */
    #[DeleteMapping("delete"), Permission("goods:clause:delete"), OperationLog]
